...
export default function Home() {
  ...
  const springProjects = useSpring({
    ...
    left: currentPage == 7 ? "0" : "-100vw",
    // color: currentPage == 7 ? "white" : "black",
  ...
  return (
    <>
      ...
      <main className="selection:text-black selection:bg-white">
            ...
            <>
              ...
              >
                <Image
                  ...
                  width={100}
                  height={100}
                  className="object-contain 2xl:w-20 w-[4.4rem]"
                />
                <span className="absolute 2xl:left-[110px] left-[80px] top-0 2xl:text-xl text-base font-light tracking-widest text-white">
                  DESIGN HOUSE
                </span>
              </a.div>
              ...
              >
                <div className="flex flex-col justify-center px-4 tracking-widest text-white">
                  ...
                  <div className={"self-end text-right lg:text-2xl 2xl:text-4xl text-xl sm:text-2xl font-light" + (isMobile ? " text-white" : " text-white/70")}>
                    <ul>
                      <li>
                        <div
                ...
                <a.div
                  className="relative pl-4 text-base lg:text-xl font-black uppercase tracking-widest text-white"
                  style={scrollSpring}
                >
                  <Image
                    src="/loader_2.png"
              ...
              <div className="absolute left-0 top-0">
                <div className="flex h-screen flex-col lg:justify-center justify-end px-8 py-20 text-white">
                  <a.div
                  ...
                  >
                    ...
                    <div className="font-light text-lg">Ditch the 2D images in favor of realtime 3D previews</div>
                  </a.div>
                  <a.div
              ...
              >
                <div className="flex h-screen w-screen flex-col justify-evenly">
                  <div className="self-center text-6xl font-black text-white">
                    People Said
                  </div>
                    <Testimonial/>
                </div>
              ...
              {/* Projects */}
              <a.div className={"absolute z-20 top-0 left-0"} style={springProjects as any}>
                <Projects/>
              </a.div>
            </>
          ) : null}
