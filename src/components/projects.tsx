...
function Projects() {
  ...
  return (
    <>
        <a.div className="flex flex-row px-20 w-screen justify-around h-screen" style={springBg}>
            <a.div className="basis-2/3 flex flex-col justify-center" style={springText}>
                ...
                <div className={'font-bold text-xl' + (project == "Intro" ? "": " hidden")}>Also also also... Check out our <span className='italic text-purple-300'>Art Gallery</span></div>
            </a.div>
            <div className="bg-slate-600/40 rounded-2xl text-white/70 basis-1/3 self-center">
                <ul className="p-4 italic text-lg">
                <li className="border-b py-2 hover:text-pink-300 transition-all duration-300" onMouseOver={handleProjectHover} onMouseLeave={handleMouseLeave}><a href="">Dazzling Donuts</a></li>
                <li className="border-b py-2 hover:text-orange-300 transition-all duration-300" onMouseOver={handleProjectHover} onMouseLeave={handleMouseLeave}><a href="">SA Builders</a></li>
                <li className="border-b py-2 hover:text-yellow-300 transition-all duration-300" onMouseOver={handleProjectHover} onMouseLeave={handleMouseLeave}><a href="">Fishb0wl</a></li>
                <li className="border-b py-2 hover:text-yellow-500 transition-all duration-300" onMouseOver={handleProjectHover} onMouseLeave={handleMouseLeave}><a href="">AlSultanTransport</a></li>
                </ul>
            </div>
        </a.div>
    </>
