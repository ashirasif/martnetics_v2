...
function IntroText({ currentPage }: { currentPage: number }) {
  ...
  return (
    <a.div className="absolute top-0" style={springLeftToRight}>
      <div className="absolute left-[100vw] top-0 flex h-screen w-screen flex-col justify-center px-4 pr-8 text-left text-white md:items-center md:text-center">
        <div className="text-6xl font-black">Who are we?</div>
        <div className="pt-2 text-base font-normal sm:text-lg md:w-2/3">
          ...
          others, we don&apos;t simply create a website for you and stop there.
          We are committed to making your product stand out with our expertise.
          We work with an affordable plan tailored to your needs until you can
      ...
      <div className="absolute left-[200vw] top-0 flex h-screen w-screen flex-col justify-center px-4 text-left text-white md:items-center md:text-center">
        ...
        <div className="pt-2 text-lg font-light sm:text-2xl lg:text-3xl">
